...
const InventoryItems = ({ cloth }) => {
    ...
    return (
        <Fade top>
            <div className="inventory-container relative m-5 text-left rounded-lg bg-white">
                {
                ...
                <div className="p-5">
                    ...
                    <div className='flex justify-between pt-3 mr-3'>
                        <button
                            ...
                            type="button"
                            className="inline-block sm:px-6 px-5 py-1 sm:py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-800 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                        >Update</button>
