    ...
    return (
        <div className='header-container'>
            ...
            >
                ...
                <ul onClick={navBtnHndle} className={`flex flex-col z-10 justify-end  md:flex-row absolute  md:relative md:opacity-100 md:top-0 top-12  right-0 mdbg-inherit  md:w-full  py-4 md:py-0 duration-500 ease-out ${toggle ? "w-3/5 opacity-100" : "w-0 opacity-0"}`}>
                    ...
                    {user ?
                        <button onClick={handleLogout} className='uppercase text-left w-4/6 md:w-auto md:mx-0 mx-auto md:pb-0.5' >LogOut</button>
                        :
