    ...
    return (
        <div className='header-container'>
            ...
            >
                ...
                <ul className={`flex flex-col z-10 justify-end  sm:flex-row absolute  sm:relative sm:opacity-100 sm:top-0 top-14  right-0 sm:bg-inherit w-1/2 sm:w-full  py-4 sm:py-0 duration-500 ease-out ${toggle ? "w-1/2 opacity-100" : "w-0 opacity-0"}`}>
